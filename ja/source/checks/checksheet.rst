...
*  :ref:`check-0471` にチェック方法の例を追加
*  :ref:`check-0461` の実装方法の例に項目追加

V5.1.0 (2024年9月26日)
======================

*  新ガイドライン項目、入力ディバイス： :ref:`gl-input-device-mobile-standard-gestures` に対応するデザイン対象のチェック内容を追加： :ref:`check-0154`
...
*  画像化されたテキストに関するガイドラインの見直しに伴い、優先度と対応するWCAG SCを変更： :ref:`check-0481` 、チェックID：0501
