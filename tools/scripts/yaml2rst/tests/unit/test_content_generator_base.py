...
class TestContentGeneratorBase:
    ...
    def test_has_relationship_mixin(self):
        """Test ContentGeneratorBase has RelationshipMixin functionality."""
        generator = self.ConcreteGenerator('en')
    ...
    def test_get_sorted_related_objects(self):
        ...
        with patch('freee_a11y_gl.relationship_manager.'
            ...
            mock_instance.get_sorted_related_objects.return_value = \
                mock_objects

            # Test the convenience method
            mock_obj = Mock()
            result = generator.get_sorted_related_objects(
