...
class TestPath:
    ...
    def test_get_static_dest_files(self):
        ...
        expected_keys = [
            ...
            'faq_index', 'faq_article_index', 'faq_tag_index', 'makefile', 'axe_rules'
        ]
    ...
    def test_template_constants(self):
        ...
        expected_template_keys = [
            'tool_example', 'allchecks_text', 'category_page', 'info_to_gl',
            'info_to_faq', 'faq_article', 'faq_tagpage', 'faq_index'
        ]
    ...
    def test_path_integration(self):
        """Test integration between get_dest_dirnames and get_static_dest_files."""
        ...
        assert static_files['faq_index'].startswith(dirnames['faq_base'])
