...
class TestFaqGeneratorBase:
    ...
    def test_get_sorted_tags(self, mock_faq_tag_class, mock_faq_tag, mock_faq_tag_empty):
        """Test getting sorted tags with articles."""
        mock_faq_tag_class.list_all.return_value = [mock_faq_tag, mock_faq_tag_empty]
...
class TestFaqIndexGenerator:
    ...
    @patch('yaml2rst.generators.content_generators.faq_generator.Faq')
    def test_get_template_data_with_tags(self, mock_faq_class, mock_faq, mock_faq_tag):
...
class TestFaqTagPageGenerator:
    ...
    @patch('yaml2rst.generators.content_generators.faq_generator.FaqTag')
    def test_get_items(self, mock_faq_tag_class, mock_faq_tag, mock_faq_tag_empty):
    ...
    def test_process_item(self, mock_faq_tag, mock_faq):
        ...
        generator.relationship_manager.get_sorted_related_objects.assert_called_once_with(
            mock_faq_tag, 'faq', key='sort_key'
        )
...
class TestFaqArticleIndexGenerator:
    ...
    def test_get_template_data(self, mock_faq_class, mock_faq):
        ...
        mock_faq_class.list_all.assert_called_once_with(sort_by='sortKey')
