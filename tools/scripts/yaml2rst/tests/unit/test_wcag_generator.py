...
class TestWcagMappingGenerator:
    ...
    @patch('yaml2rst.generators.content_generators.wcag_generator.WcagSc')
    def test_get_template_data(self, mock_wcag_sc_class, mock_wcag_sc, mock_guideline):
    ...
    @patch('yaml2rst.generators.content_generators.wcag_generator.WcagSc')
    def test_get_template_data_no_guidelines(self, mock_wcag_sc_class, mock_wcag_sc):
...
class TestPriorityDiffGenerator:
    ...
    @patch('yaml2rst.generators.content_generators.wcag_generator.WcagSc')
    def test_get_template_data_with_diffs(self, mock_wcag_sc_class, mock_wcag_sc_diff):
        """Test template data generation with priority differences."""
        # Mock SC with different level and local_priority
        mock_wcag_sc_class.get_all.return_value = {'diff_sc': mock_wcag_sc_diff}
    ...
    @patch('yaml2rst.generators.content_generators.wcag_generator.WcagSc')
    def test_get_template_data_no_diffs(self, mock_wcag_sc_class, mock_wcag_sc):
    ...
    @patch('yaml2rst.generators.content_generators.wcag_generator.WcagSc')
    def test_get_template_data_mixed(self, mock_wcag_sc_class, mock_wcag_sc, mock_wcag_sc_diff):
        """Test template data generation with mixed SCs (some with diffs, some without)."""
        mock_wcag_sc_class.get_all.return_value = {
    ...
    def test_get_template_data_multiple_diffs(self, mock_wcag_sc_class):
        ...
        mock_sc1.template_data.return_value = {'id': 'sc1', 'level': 'AAA', 'local_priority': 'AA'}
        
        mock_sc2 = Mock()
        mock_sc2.level = 'AA'
        mock_sc2.local_priority = 'A'
        mock_sc2.template_data.return_value = {'id': 'sc2', 'level': 'AA', 'local_priority': 'A'}
