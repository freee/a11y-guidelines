...
class TestCategoryGenerator:
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_category_generator_initialization(self, mock_list_all):
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_success(self, mock_list_all):
        ...
        # Mock the relationship manager method directly on the generator
        # instance
        generator.relationship_manager.get_sorted_related_objects = Mock(
            side_effect=lambda cat, rel_type: (
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_empty_categories(self, mock_list_all):
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_category_with_no_guidelines(self, mock_list_all):
        ...
        # Mock the relationship manager to return no guidelines
        generator.relationship_manager.get_sorted_related_objects = Mock(
            return_value=[]
        )
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_with_priority_sorting(self, mock_list_all,
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_data_structure(self, mock_list_all,
                                     mock_relationship_manager):
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_generate_filename_generation(self, mock_list_all):
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_preprocess_data(self, mock_list_all):
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_postprocess_data(self, mock_list_all):
...
class TestCategoryGeneratorIntegration:
    ...
    @patch('yaml2rst.generators.content_generators.'
           'category_generator.Category.list_all')
    def test_full_generation_workflow(self, mock_list_all,
                                      mock_relationship_manager):
        ...
        mock_rm_instance = Mock()
        mock_rm_instance.get_sorted_related_objects.return_value = [
            mock_guideline1, mock_guideline2
        ]
        mock_relationship_manager.return_value = mock_rm_instance
    ...
    def test_error_recovery(self, mock_list_all, mock_relationship_manager):
        ...
        mock_rm_instance.get_sorted_related_objects.side_effect = (
            mock_get_related
        )
        mock_relationship_manager.return_value = mock_rm_instance
